...
WHERE event_date >= TIMESTAMP(DATE_SUB(CURRENT_DATE(), INTERVAL 60 DAY))
)
...
SELECT
    ...
    carts,
    purchases,
    ROUND( carts*100/views) AS view_to_cart_conversion_rate,
    ROUND( purchases*100/views) AS view_to_purchase_conversion_rate,
